                    ...
                    <div class="layui-row">
                        <div class="layui-col-md-offset2 layui-col-md8">
                            <div class="layui-col-md12 card">
                                <div class="search">
                                        <input type="input" id="search-input" class="search-input" placeholder="请输入关键字" value="${keywords!""}">
                                        <button class="search-button" onclick="go()">搜索</button>
                                </div>
                            </div>
                ...
                <div class="layui-col-xs12 mobile-main">
                    ...
                    <div class="row">
                        <div class="layui-col-xs12 card">
                            <div class="search">
                                <input type="input" id="m-search-input" class="search-input" placeholder="请输入关键字" value="${keywords!""}">
                                <button class="search-button" onclick="mGo()">搜索</button>
                            </div>
                        </div>
