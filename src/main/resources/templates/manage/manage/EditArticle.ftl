                    ...
                    <form class="layui-form" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="title" id="title" value="${article.title}" required  placeholder="请输入标题" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="imgPath" id="imgPath" class="layui-input" value="${article.img}">
                        <input type="hidden" name="id" id="id" value="${article.id}" class="layui-input">


                        <div class="layui-form-item">
                            <label class="layui-form-label">图片预览</label>
                            <div class="layui-input-block">
                                <img src="${article.img}" id="imgPreview" alt="图片预览" width="10%" height="10%"/>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <button class="layui-btn" onclick="editArticle()" type="button">提交</button>
                            </div>
                        </div>
