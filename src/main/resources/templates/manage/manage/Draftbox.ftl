                    ...
                    <div class="layui-row">
                        ...
                        <div class="row">
                            <div class="layui-col-md12 article-pagination">
                                <a href="/manage/draftbox?page=1"><span class="layui-btn layui-btn-xs">首页</span></a>
                                <a href="/manage/draftbox?page=${currentPage-1}"><span class="layui-btn layui-btn-xs">上一页</span></a>
                                <#if (maxPage > 5) >
                                    <#list 1..5 as page>
                                    <a href="/manage/draftbox?page=${page}"><span class="layui-btn layui-btn-xs">${page}</span></a>
                                    </#list>
                                ...
                                <a href="/manage/draftbox?page=${currentPage+1}"><span class="layui-btn layui-btn-xs">下一页</span></a>
                                <a href="/manage/draftbox?page=${maxPage}"><span class="layui-btn layui-btn-xs">尾页</span></a>
                            </div>
                        </div>
                    </div>
                </div>
